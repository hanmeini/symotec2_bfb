...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE cust SET kode='$kode', nama='$nama', alamat='$alamat', npwp='$npwp' WHERE id=$id";
    if ($conn->query($query)) {
        echo "<script>alert('Data berhasil diupdate!'); window.location.href = 'cust.php';</script>";
    } else {
        $msg = "Gagal mengupdate data: " . $conn->error;
    }
}

$result = $conn->query("SELECT * FROM cust WHERE id=$id");
...
<body>
    <div class="table-container">
        ...
        <a href="cust.php" class="left-icon"><i class="fa-solid fa-circle-left"></i></a>
    </div>
    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <div class="btn-group">
                ...
                <a href="cust.php" class="btn-cancel">Batal</a>
            </div>
        </form>
    </div>
</body>
