...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE brand_b SET brand='$brand', deskripsi='$deskripsi', updated_at=NOW() WHERE id_brand=$id";
...
$sql = "SELECT * FROM brand_b WHERE id_brand=$id";
...
<a href="brand.php" class="home-icon"><i class="fas fa-home"></i></a>
<a href="brand.php" class="left-icon"><i class="fa-solid fa-circle-left"></i></a>

<h1>Edit Data Brand</h1>

<form method="POST">
    <input type="text" name="brand" value="<?= htmlspecialchars($row['brand']) ?>" required>
