...
// Header
$headers = [
    'ID', 'Tanggal', 'Invoice', 'Kode Booking', 'Customer', 'Tagihan', 'Bayar', 'Sisa', 
...
$sheet->setCellValue("K$rowNum", $total_1_30);
$sheet->setCellValue("L$rowNum", $total_31_60);
$sheet->setCellValue("M$rowNum", $total_61_90);
$sheet->setCellValue("N$rowNum", $total_90_plus);

// Format bold untuk total
$sheet->getStyle("E$rowNum:N$rowNum")->getFont()->setBold(true);

// Output file Excel jika tombol export ditekan
if (isset($_GET['export']) && $_GET['export'] === 'excel') {
    header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    header('Content-Disposition: attachment;filename="ARU.xlsx"');
