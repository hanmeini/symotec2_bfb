...
<form method="get" action="export_23belum.php" style="text-align: center; margin-bottom: 20px;">
    <input type="hidden" name="filter" value="<?php echo htmlspecialchars($filter ?? ''); ?>">
    <button type="submit">Export Excel</button>
    <button type="button" onclick="window.location.href='23d.php'">SUDAH DITERIMA</button>
    <button type="button" onclick="window.location.href='23up.php'" style="position: fixed; background:blue ;  right: 20px;">Upload Bukpot</button>
      ...
      $pph23 = floatval($row['pph23']);
        ...
        echo "<tr>
                ...
                <td class='action-icon'>
                    <button type='button' onclick='openPopup(\"23in.php?J=" . urlencode($row['id']) . "\")'>Input Bukpot</button>
                </td>
              </tr>";
    }
