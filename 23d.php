...
FROM 
    pph23 pph23
WHERE 
    (pph23.bukpot IS NOT NULL AND pph23.bukpot <> '')
...
<form method="get" action="export_23sudah.php" style="text-align: center; margin-bottom: 20px;">
    <input type="hidden" name="filter" value="<?php echo htmlspecialchars($filter ?? ''); ?>">
    <button type="submit">Export Excel</button>
    <button type="button" onclick="window.location.href='23.php'">BELUM DITERIMA</button>
