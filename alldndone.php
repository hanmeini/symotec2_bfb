...
<body>
    <div class="table-container">
        ...
        <a href="alldnap.php" class="left-icon">
            <i class="fa-solid fa-circle-left"></i>
        </a>
<title>DN yang sudah digunakan</title></head><body>
<h1>DN APyang sudah digunakan</h1>
...
<form method="GET" style="text-align:center;" class="mb-3">
    ...
    <a href="alldndone.php" class="btn btn-secondary">Reset</a>
    
    <a href="exportdndone_excel.php?filter_customer=<?= urlencode($filter) ?>" class="btn btn-success">
