...
<head>
    <meta charset="UTF-8">
    <title>Daftar DN AR BELUM DIGUNAKAN > 0</title>
...
<body class="container mt-4">
    <h3 class="mb-4">DAFTAR DN AR BELUM DIGUNAKAN</h3>

    <form method="GET" class="form-inline mb-3">
            <a href="inardn.php" class="btn btn-info" style="margin-right: 10px;">
       <i class="fas fa-plus-circle"></i> Tambah DN AP</a>
        ...
        <a href="alldnar.php" class="btn btn-secondary ml-2">Reset</a>
        <a href="exportdnar_excel.php?filter_customer=<?= urlencode($filter_customer) ?>" class="btn btn-success ml-2">
            <i class="fas fa-file-excel"></i> Export Excel
        </a>
         <a href="alldndonear.php" class="btn btn-info" style="margin-left: 10px;">
