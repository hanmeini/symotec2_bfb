...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO jenis_b (jenis, deskripsi) VALUES ('$jenis', '$deskripsi')";
...
// Ambil data jenis
$sql = "SELECT * FROM jenis_b ORDER BY id_jenis DESC";
...
<div class="form-container">
    ...
    <form method="POST">
        <input type="text" name="jenis" placeholder="Masukkan Nama Jenis" required>
            ...
            <?php if ($result->num_rows > 0) : ?>
                <?php while ($row = $result->fetch_assoc()) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="jenis_edit.php?id=<?= $row['id_jenis'] ?>" class="edit-button">Edit</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else : ?>
