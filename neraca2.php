...
<div style="margin-top: 15px;">
<a href="export_n.php?bulan_awal=<?= urlencode($bulan_awal) ?>&bulan_akhir=<?= urlencode($bulan_akhir) ?>&tahun=<?= urlencode($tahun_terpilih) ?>&location=<?= urlencode($loc_terpilih) ?>&devisi=<?= urlencode($dev_terpilih) ?>" target="_blank">
...
$selisih_tahun_berjalan =
    (float)$res_curr['aset']
    - (float)$res_curr['kewajiban_modal'];
...
if (isset($data['31.03.01.001'])) {
    ...
    $data['31.03.01.001']['kredit_neraca'] = $selisih_tahun_berjalan;
    $data['31.03.01.001']['saldo_akhir'] = $selisih_tahun_berjalan;
}
...
echo "<tr style='font-weight:bold; background:#ffd0d0;'>
    <td colspan='5' align='center'>SELISIH NERACA</td>
