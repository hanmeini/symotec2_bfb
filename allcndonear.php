...
<title>CN AR yang sudah digunakan</title>
<link rel="stylesheet"
...
<body>
     <div class="table-container">
        ...
        <a href="allcnar.php" class="left-icon">
            <i class="fa-solid fa-circle-left"></i>
        </a>
<h1>CN yang sudah digunakan</h1>
<form method="GET" style="text-align:center;" class="mb-3">
    ...
    <a href="exportcndonear_excel.php?filter_customer=<?= urlencode($filter) ?>" class="btn btn-success">
