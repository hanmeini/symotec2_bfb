...
<div class="container">
    <h2>INPUT DN AP</h2>
    <form id="formJurnal" action="save_dnap.php" method="post" enctype="multipart/form-data" onsubmit="return validateKodeBooking();">
        ...
        <br>  <br>
          <label for="lampiran">Nilai DN:</label>
<input type="text" name="dn" value="0" oninput="formatLargeNumber(this); calculateTotal();" onfocus="removeFormatting(this)" onblur="applyFormatting(this)" style="text-align:right;">
...
function validateKodeBooking() {
    ...
    return confirm("Apakah Anda sudah yakin dengan DN?");
}
