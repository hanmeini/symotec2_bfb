...
// Judul
$sheet->setCellValue('A1', "Laporan Aset dan Penyusutan - $label_periode");
...
$sql = "SELECT kode, nama, tanggal, beli FROM aset WHERE kode LIKE ? OR nama LIKE ? ORDER BY kode ASC";
...
// Output file
$filename = "Laporan_Aset_{$tahun}_{$bulan}.xlsx";
